...
export const useReducerQuestions: Question[] = [
  ...
  new Question(
    "Vad är huvudskillnaden mellan `useState` och `useReducer` i TypeScript?",
    [
      new CorrectAnswer(
        "`useReducer` är mer lämplig för hantering av komplexa tillstånd och åtgärder.",
      ),
      new IncorrectAnswer(
        "`useReducer` är endast avsett för klasskomponenter.",
      ),
      new IncorrectAnswer(
  ...
  new Question(
    "Vad är den första värdet som `useReducer` returnerar i TypeScript?",
    [
  ...
  new Question(
    "Vad är syftet med `dispatch`-funktionen som returneras av `useReducer` i TypeScript?",
    [
      new IncorrectAnswer(
  ...
  new Question(
    "Vilken typ av åtgärd förväntar sig reducerfunktionen som den första parameter i TypeScript?",
    [
      new CorrectAnswer(
  ...
  new Question(
    "Kan du använda `useReducer` tillsammans med `useEffect` i samma funktionella komponent i TypeScript?",
    [
      new CorrectAnswer(
